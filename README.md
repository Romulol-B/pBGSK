...
### Scikit-learn Compatible Selector

The repository now also exposes a selector compatible with `Pipeline`,
`GridSearchCV`, and `get_support`.

```python
from sklearn.pipeline import Pipeline
from sklearn.neighbors import KNeighborsClassifier

from src.utils.pBGSK import PBGSKFeatureSelector

selector = PBGSKFeatureSelector(
    population_size=20,
    nfe_total=100,
    lower_k=1,
    upper_k=10,
